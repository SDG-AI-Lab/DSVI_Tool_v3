...
const Home = () => {
  return (
    <div className="bg-white my-2 mx-5 px-2 py-5 rounded-lg">
      ...
      <p className="font-sans text-gray-700 text-md font-normal py-2 px-5 ">
