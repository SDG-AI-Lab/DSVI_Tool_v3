    ...
    return isBrowser ? (
        <div className="bg-white my-2 mx-5 px-2 py-5 rounded-lg">
            <div class="container">
                ...
                <p>Online UN Volunteers are actively contributing to DSVI Volunteer Developer Team Project. Many thanks
                    to all our volunteers for their contribution</p>
                <br></br>
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <p class="card-text menu">
                                                <div className="py-2">
                                                    <a href={val.Linkedin} className="-m-2 flex items-center p-2"
                                                       target="_blank">
                                                        <img src="./images/linkedin.png" alt="Logo" width={30}
                                                             height={30} className="block h-auto w-5 flex-shrink-0"/>
                                                        <span
                                                            className="ml-3 block text-base font-medium text-gray-900">{val.name}</span>
                                                    </a>
                                                </div>
                                            </p>
