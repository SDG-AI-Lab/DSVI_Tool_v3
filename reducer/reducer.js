export const initalState = {
        ...
        "data": [
            {
                ...
                data: [                    
                    {
                        id: 1.1,
                        slug: 'social_vulnerability_random_forest',
                    ...
                    {
                        id: 1.2,
                        slug: 'social_vulnerability_xgboost',
                        title: 'SV: XGBoost',
                        status: false,
                        value: 70
                    },
    ...
    "vulnerability": false,
    "categories": [{
        id: 1, title: "Very Low", slug: 'very_low', color: 'bg-lime-500', status: true
    }, {
        id: 2, title: "Low", slug: 'low', color: 'bg-green-500', status: true
    }, {
        id: 3, title: "Middle", slug: 'middle', color: 'bg-yellow-500', status: true
    }, {
        id: 4, title: "High", slug: 'high', color: 'bg-orange-500', status: true
    }, {
        id: 5, title: "Very High", slug: 'very_high', color: 'bg-red-500', status: true
    }],
    "dsv_indicator": false,
    "data_column": [{
