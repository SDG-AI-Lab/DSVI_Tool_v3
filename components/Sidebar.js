...
const Sidebar = () => {
  ...
  const [drawofInterestStatus, setDrawofInterestStatus] = useState(false);
  ...
  const [selectedDataColumn, setSelectedDataColumn] = useState(0);
  ...
  return (
            ...
            <ul class="relative px-1 ">
              <li class="relative">
                ...
                >
                  ...
                  <span>{areaofInterestStatus == true ? 'Hide Area of Interest' : 'Show Area of Interest'}</span>
                </a>
              </li>
              <li class="relative" id="sidenavSecEx2">
                ...
                >
                  ...
                  {
                    socioEconomicLayersStatus == true ?
                ...
                <ul class="relative accordion-collapse collapse" id="collapseSidenavSecEx2" aria-labelledby="sidenavSecEx2" data-bs-parent="#sidenavSecExample">
                  ...
                  {
                    socioEconomicLayersStatus == true && socioEconomicLayers.map((val, index) => {
                      return (
                        <li class="relative">
                          <div class="flex i items-center">
                            <input class="ml-5 bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded" id="flowbite" aria-describedby="flowbite" type="checkbox"
                              checked={val.status}
                              onClick={() => {
                                const newItems = [...socioEconomicLayers];
                                newItems[index] = {
                                  id: val.id,
                                  slug: val.slug,
                                  title: val.title,
   ...
   "
                                    ...
                                    />
                                    <input type="range" class="w-full" min="1" max="100" step="1" value={val.value} className=" form-range
   h-6
   p-0
   focus:outline-none focus:ring-0 focus:shadow-none"/>
              ...
              <li class="relative" id="sidenavSecEx3">
                ...
                <ul class="relative accordion-collapse collapse" id="collapseSidenavSecEx3" aria-labelledby="sidenavSecEx3" data-bs-parent="#sidenavSecExample">
                  ...
                  {
                    geodataLayersStatus == true && geodataLayers.map((val, index) => {
                      return (
                        <li class="relative">
                          <a href="#!" class="flex font-bold items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">{val.title}</a>
   ...
   focus:outline-none focus:ring-0 focus:shadow-none"/>
            ...
            <li class="relative">
              <a class="flex items-center text-sm py-4 px-2 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="primary"
                ...
                onClick={() => setVulnerabiltyStatus(!vulnerabilityStatus)}
              ...
              >
                ...
                <span>{vulnerabilityStatus == true ? 'Hide Vulnerabilty' : 'Show Vulnerabilty'}</span>
              </a>
                      ...
                      <div className=" px-6">
                        {
                          categories.map((val, index) => {
                            return <div className="flex text-sm text-gray-700 my-1">
                              ...
                              <div className={`w-3 h-3 rounded-full ` + `${val.color}` + ` mt-1 mx-2`}></div>
            ...
            <li class="relative">
              <a class="flex items-center text-sm py-4 px-2 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="primary"
                ...
                onClick={() => setDsvIndicatorStatus(!dsvIndicatorStatus)}
              ...
              >
                ...
                <span>{dsvIndicatorStatus == true ? 'Hide DSV Indicators' : 'Show DSV Indicators'}</span>
              </a>

              {
                dsvIndicatorStatus == true ?
                  <ul class="relative accordion-collapse collapse" id="collapseSidenavSecEx2" aria-labelledby="sidenavSecEx2" data-bs-parent="#sidenavSecExample">
                    <li class="relative">
