...
export const MapMarker = ({ pathname }: MapMarkerProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={
        pathname === 'map1'
          ? 'h-6 w-6 stroke-blue-700 '
          : 'h-6 w-6 stroke-slate-700'
      }
      fill="none"
      viewBox="0 0 24 24"
      strokeWidth="2"
...
export const DialogIcon = ({ pathname }: MapMarkerProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className={
        pathname === 'about'
          ? 'h-6 w-6 stroke-blue-700 font-bold'
          : 'h-6 w-6 stroke-slate-700'
      }
      fill="none"
      viewBox="0 0 24 24"
...
export const AdministrativeIcon = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="mr-2 h-4 w-4"
