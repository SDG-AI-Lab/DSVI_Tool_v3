...
export const GlobeIcon2 = () => {
  return (
    <svg
      ...
      strokeWidth="5"
      className="h-5 w-5 drop-shadow-lg hover:h-8 hover:w-8 hover:text-purple-800 hover:drop-shadow-2xl"
      viewBox="0 0 24 24"
    >
...
export const TwitterIcon = () => {
  return (
    <svg
      ...
      strokeLinejoin="round"
      strokeWidth="2"
      className="h-5 w-5 drop-shadow-lg hover:h-8 hover:w-8 hover:text-blue-400 hover:drop-shadow-2xl"
      viewBox="0 0 24 24"
    >
