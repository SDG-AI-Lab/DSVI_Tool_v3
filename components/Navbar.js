...
const Navbar = () => {
    ...
    return (// MAP WINDOW
        <nav className="align-bottom mb-2 flex items-end font-bold">
            <Link href={'/'} as={`/`}>
                <a className="mr-5 hover:text-gray-900 px-2 flex">
                    ...
                    <span className={pathname === '/' ? 'text-lg font-bold text-blue-700 pl-1' : 'pl-1'}>Map Window</span>
                </a>
            </Link>
            ...
            <Link href="/about">
                <a className="mr-5 hover:text-gray-900 px-2 flex font-bold">
                    ...
                    <span className={pathname === 'about' ? 'text-lg font-bold text-blue-700 pl-1' : 'pl-1'}>About us</span>
                </a>
            </Link>
        </nav>)
}
