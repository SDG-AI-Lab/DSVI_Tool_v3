...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="align-bottom flex items-end">
      <Link href={'/'} as={`/`}>
      <a className="text-lg mr-5 hover:text-gray-900 px-2 flex">
        <svg xmlns="http://www.w3.org/2000/svg" className={pathname == 'map1' ? 'stroke-blue-700 h-6 w-6' : 'h-6 w-6 stroke-slate-700'} fill="none" viewBox="0 0 24 24" strokeWidth="2">
          ...
          <span className={pathname == '/' ? 'text-blue-700 pl-1 mb-2' : 'pl-1'}>Map Window</span>
        </a>
      </Link>
    ...
    {/* // About us */}
      ...
      <Link href="/about">
        <a className="text-lg mr-5 hover:text-gray-900 px-2 flex mb-2">
        <svg xmlns="http://www.w3.org/2000/svg" className={pathname == 'about' ? 'stroke-blue-700 h-6 w-6' : 'h-6 w-6 stroke-slate-700'} fill="none" viewBox="0 0 24 24" strokeWidth="2">
          ...
          <span className={pathname == 'about' ? 'text-lg text-blue-700 pl-1' : 'pl-1'}>About us</span>
        </a>
      </Link>
    </nav>  
  )
