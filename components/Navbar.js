        ...
        <nav class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
          ...
          <Link href="/map1">
            <a class="mr-5 hover:text-gray-900 px-2 flex">
              ...
              <span className={pathname == 'map1' ? 'text-blue-700 pl-2' : 'pl-2'}>Map 1</span>

            </a>
          </Link>
          <Link href="/map2">
            <a class="mr-5 hover:text-gray-900 px-2 flex ">
              <svg xmlns="http://www.w3.org/2000/svg" className={pathname == 'map2' ? 'stroke-blue-700 h-6 w-6' : 'h-6 w-6 stroke-slate-700'} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
              </svg>
              <span className={pathname == 'map2' ? 'text-blue-700 pl-2' : 'pl-2'}>Map 2</span>
