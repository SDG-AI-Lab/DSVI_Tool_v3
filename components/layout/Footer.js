const Footer = () => {
  ...
  <div class="container px-5 py-2 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2020 —
      <a href="https://sdgailab.org/" class="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">@SDG AI LAB</a>
    </p>
...
<img src="/images/UNDP_Logo.png" className=" h-20"/>
    ...
    <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
      ...
      <a class="ml-3 text-gray-500">
        <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="5" class="w-5 h-5" viewBox="0 0 24 24">
